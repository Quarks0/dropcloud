...
Song.create({title: "Brave", artist: "gLadiator", url: "http://res.cloudinary.com/duhmzsirt/video/upload/v1478675572/02_-_gLAdiator_-_Brave_feat._Vindata_Mothica_khycfx.mp3", image_url: "", user_id: 3})
Song.create({title: "Citi Bike", artist: "Lido", url: "http://res.cloudinary.com/duhmzsirt/video/upload/v1478382946/07_-_Citi_Bike_rivi53.mp3", image_url: "", user_id: 2 })
Song.create({title: "U Don't Know", artist: "Alison Wonderland", url: "http://res.cloudinary.com/duhmzsirt/video/upload/v1478281042/02_-_U_Don_t_Know_Feat._Wayne_Coyne_atkn5r.mp3", image_url: "", user_id: 4})
...
Song.create({title: "Wavy", artist: "Flosstradamus", url: "http://res.cloudinary.com/duhmzsirt/video/upload/v1478217334/06-Flosstradamus_NYMZ-Wavy_nnpouv.mp3", image_url: "", user_id: 5})
...
Song.create({title: "Drop Top", artist: "Flosstradamus", url: "http://res.cloudinary.com/duhmzsirt/video/upload/v1478218636/04-Flosstradamus-Drop_Top_ft._Travis_Porter_l0rdmv.mp3", image_url: "", user_id: 2})
Song.create({title: "Dr Pepper", artist: "Various Artists", url: "http://res.cloudinary.com/duhmzsirt/video/upload/v1478675550/01_-_Doctor_Pepper_ejb5yu.mp3", image_url: "", user_id: 6})
Song.create({title: "I Just Can't Deny", artist: "Keys N' Krates", url: "http://res.cloudinary.com/duhmzsirt/video/upload/v1478675507/01_I_Just_Can_t_Deny_sdmnwh.mp3", image_url: "", user_id: 7})
...
Song.create({title: "Naked", artist: "Alison Wonderland", url: "http://res.cloudinary.com/duhmzsirt/video/upload/v1478021319/04_-_Naked_Alison_Wonderland_x_Slumberjack_xztymm.mp3", image_url: "", user_id: 3})
